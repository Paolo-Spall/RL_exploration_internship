...
from ..utils import greedy_index, step_toward
...
#class ExpGrid2D:
    ...
    def cluster_frontiers(self):
        ...
        num_centroids = min(len(self.centroids), self.centroids_obs_len)
        if num_centroids >0:
            self.obs_centroids[:num_centroids] = self.centroids[:num_centroids].copy()
