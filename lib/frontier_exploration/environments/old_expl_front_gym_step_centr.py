...
from lib.grid_env.obst_grid_gen import generate_grid
from lib.frontier_exploration.frontiers import find_frontiers, cluster_frontiers, pad_obs_centroids


class ExplFrontGymStepCentr(gym.Env):
    ...
    def __init__(self, 
        ...
        self.action_space = spaces.Discrete(centroids_obs_len)  # R,D,L,U
    ...
    def reset(self, seed=None, options=None):
        ...
        self.grid = generate_grid(width=self.width, 
                                  height=self.height, 
        ...
        self.centroids, self.clusters  = cluster_frontiers(frontiers)
        self.obs_centroids = pad_obs_centroids(self.centroids, self.centroids_obs_len)   
