...
# class StepObstAvoidMixin(StepMixin):
...
#     def check_path(self, target_centroid):
...
#         self.check_path(target_centroid)

#         if self.avoidance_path:
#             next_pos = self.avoidance_path.pop(0)
...
#             self.avoidance_path = compute_path(self.obs_grid,
#                                               self.agent_pos,
#                                               target_centroid,
#                                               self.obstacle_color,
#                                               self.moves)
