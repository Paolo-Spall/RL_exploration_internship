    ...
    if os.path.isdir(directory):
        ...
        for file_rel in file_list:
            ...
            if file.endswith('.yaml'):
                ...
                if 'frac07' in mod_name:
                    if not 'frac07' in mod_name:
                        new_mod_name = mod_name + '_frac07'
                elif 'frac02' in mod_name:
                    if not 'frac02' in mod_name:
                        new_mod_name = mod_name + '_frac02'
                ...
                new_file_name = file.replace('.yaml', '_reverse.yaml')
        ...
        new_directory = directory.replace('16','20') + '_reverse'
