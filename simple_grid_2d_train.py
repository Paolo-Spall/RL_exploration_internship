...
from lib.free_RL_exploration.environments import Simple2DGrid
from stable_baselines3.common.evaluation import evaluate_policy

size = 10
env = Simple2DGrid(size=size, render_mode=False)

model_name = "my_2d_grid_MultiInput_1e5_agent"

model = DQN("MultiInputPolicy", env, verbose=0, device="cpu",
